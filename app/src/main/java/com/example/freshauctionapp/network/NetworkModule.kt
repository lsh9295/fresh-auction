...
object NetworkModule {
    private val keyValue = "extnbCu4SI01Yg05Le4eoKY2lAmc2Jq9%2F6btYg1YDLuEpm5wDiin%2B2ujdppr1nfMO3r0Gv05E9UKJrgovNeEIQ%3D%3D"

    /* OkHttp 요청을 전송할 OkHttpClient 객체(서버에 검색 요청시 사용) 생성 */
    val client: OkHttpClient by lazy {
        OkHttpClient.Builder()
            .connectTimeout(2, TimeUnit.MINUTES)
            .readTimeout(2, TimeUnit.MINUTES) // readTimeout(읽기 지연시간) 설정
            .build()
    }
